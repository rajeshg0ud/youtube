...
function VideoSuggestionCard({info}) {
    ...
    function formatViewsCount(views) {
      ...
      return (
        ...
        <div className=' py-1  cursor-pointer hover:border-radius-none flex flex-col sm:flex-row  w-[95%] sm:w-[1000px] ml-2'>
          <img
            src={thumbnails.high.url}
            className='h-52 sm:h-28 w-[90%] sm:w-[87%] sm:max-w-48 rounded-xl object-cover transition-all duration-300 ease-in-out hover:rounded-none'
          />
