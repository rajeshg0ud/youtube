  ...
  return (
    <div className=' fixed grid grid-flow-col p-3 shadow-lg w-full z-10  bg-white top-0 left-0 items-center'>
        <div className='flex col-span-1'>
            <img src={menu} alt="menu" className=' h-6 w-6 mx-4 mt-2 cursor-pointer  hidden sm:block' onClick={() => menuBarSet()}/>
        ...
        <input type='text' placeholder='Search' className=' w-4/6 sm:w-4/5 py-2 h-[34px] sm:h-[38px]  pl-4 border border-gray-500 rounded-l-full' onChange={(e)=>setSearchQuery(e.target.value)}/>
         <button className=' px-1 border py-2 sm:px-4 border-gray-500 rounded-r-full  h-[34px] sm:h-[38px]  bg-gray-100 hover:bg-gray-200 self-center' >
