...
function Header(){
  ...
  return (
    <div className=' fixed grid grid-flow-col p-3 shadow-lg w-full z-10  bg-white top-0 left-0 items-center'>
        ...
        <input type='text' placeholder='Search' className=' w-4/5 py-2 h-[34px] sm:h-[38px]  pl-4 border border-gray-500 rounded-l-full' onChange={(e)=>setSearchQuery(e.target.value)}/>
         <button className=' border py-2 px-4 border-gray-500 rounded-r-full  h-[34px] sm:h-[38px]  bg-gray-100 hover:bg-gray-200 self-center' >
