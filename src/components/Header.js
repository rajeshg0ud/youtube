...
function Header(){
  ...
  return (
    <div className=' fixed grid grid-flow-col p-3 shadow-lg w-full z-10  bg-white top-0 left-0 items-center'>
        ...
        <input type='text' placeholder='Search' className=' w-7/12 sm:w-4/5 py-2 h-[30px] sm:h-[38px]  pl-4 border border-gray-500 rounded-l-full' onChange={(e)=>setSearchQuery(e.target.value)}/>
